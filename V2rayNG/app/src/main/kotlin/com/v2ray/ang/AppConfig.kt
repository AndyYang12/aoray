 ...
 */
object AppConfig {
    // the pinned engine (AndroidLibXrayLite 1.8.11) takes the probe url as an
    // argument; upstream gained this in the same bump
    const val TEST_SPEED_URL = "https://cp.cloudflare.com/generate_204"
